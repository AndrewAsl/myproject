...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  PRIMARY KEY (`account_id`,`users_user_id`),
  KEY `fk_accounts_users_idx` (`users_user_id`),
  CONSTRAINT `fk_accounts_users` FOREIGN KEY (`users_user_id`) REFERENCES `users` (`user_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
CREATE TABLE IF NOT EXISTS `payed_period` (
  ...
  `prices_for_pay_period_pricepp_id` int(11) NOT NULL,
  PRIMARY KEY (`payp_id`,`prices_for_pay_period_pricepp_id`),
  KEY `fk_payed_period_prices_for_pay_period1_idx` (`prices_for_pay_period_pricepp_id`),
  CONSTRAINT `fk_payed_period_prices_for_pay_period1` FOREIGN KEY (`prices_for_pay_period_pricepp_id`) REFERENCES `prices_for_pay_period` (`pricepp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `user_roles_ur_id` int(11) NOT NULL,
  ...
  `payed_period_payp_id` int(11) NOT NULL,
  PRIMARY KEY (`user_id`,`user_roles_ur_id`,`payed_period_payp_id`),
  KEY `fk_users_user_roles1_idx` (`user_roles_ur_id`),
  KEY `fk_users_payed_period1_idx` (`payed_period_payp_id`),
  CONSTRAINT `fk_users_payed_period1` FOREIGN KEY (`payed_period_payp_id`) REFERENCES `payed_period` (`payp_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_users_user_roles1` FOREIGN KEY (`user_roles_ur_id`) REFERENCES `user_roles` (`ur_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
